...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='seaships',
                                 help='coco | kitti | coco_hp | pascal | seaships | face')
        ...
        self.parser.add_argument('--arch', default='dla_34',
                                 help='model architecture. Currently tested'
                                      ...
                                      'dlav0_34 | dla_34 | hourglass | mbv2_10')
        ...
        self.parser.add_argument('--lr_step', type=str, default='100,150',
