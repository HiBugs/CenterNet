            ...
            if re.search('jpg', img_path):
                ...
                for j in range(facenum):
                    ...
                    if len(line)>4:
                        ...
                        annotation['keypoints'] = [-1, -1, 2, -1, -1, 2, -1, -1, 2, -1, -1, 2, -1, -1, 2]
...
img_path = '/nfs/home/zjb/workspace/Datasets/WiderFace/WIDER_val/images'
txt_path = '/nfs/home/zjb/workspace/Datasets/WiderFace/WIDER_val/val.txt'
save_path = '/nfs/home/zjb/workspace/Datasets/WiderFace/WIDER_val/keypoints_val.json'
