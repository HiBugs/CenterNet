...
if __name__ == '__main__':
    txt_path = '/nfs/home/zjb/workspace/Datasets/WiderFace/retinaface_gt_v1.1/val/label.txt'
    save_path = '/nfs/home/zjb/workspace/Datasets/WiderFace/WIDER_val/val.txt'
